...
sns.barplot(x=df["Quantity"], y=df["Sales"], errorbar=None)
...
# create plot to check the impact
plt.figure(figsize=(8, 5))
sns.barplot(x=df["Discount"], y=df["Sales"], errorbar=None)
...
# create plot to check the impact
plt.figure(figsize=(8, 5))
sns.barplot(x=df["Discount"], y=df["Profit"], errorbar=None)
